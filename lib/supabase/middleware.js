...
export async function updateSession(request) {
    ...
    if (
        ...
        // Provjeri je li ovo test ruta - ako jest, pustimo Next.js da vrati 404
        const pathname = request.nextUrl.pathname;
        const isTestRoute =
            pathname.includes("non-existent") ||
            pathname.includes("test-route") ||
            pathname.match(/^\/[^/]+-that-does-not-exist/);
